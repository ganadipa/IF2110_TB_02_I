...
#define ROW_CAP_Matriks 100
#define COL_CAP_Matriks 100

typedef int IdxType; /* Index baris, kolom */
typedef int ElType;
typedef struct
{
   ElType mem[ROW_CAP_Matriks][COL_CAP_Matriks];
   int rowEff; /* banyaknya/ukuran baris yg terdefinisi */
   int colEff; /* banyaknya/ukuran kolom yg terdefinisi */
} Matrix;
#define ROW_EFF_Matriks(M) (M).rowEff
#define COL_EFF_Matriks(M) (M).colEff
#define ELMT_Matriks(M, i, j) (M).mem[(i)][(j)]
