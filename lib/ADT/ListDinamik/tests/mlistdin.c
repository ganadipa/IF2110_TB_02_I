...
<<<<<<< Updated upstream
    ...
    //     break;       
=======
        getFirstIdxListDin(ld1);
        getLastIdxListDin(ld1);
        indexOfListDin(ld1, i);
        countValListDin(ld1, i);
        break;
    ...
    case 4:
        ...
        readListDin(&ld1);
        scanf("%d", &i);
        isIdxValidListDin(ld1, i);  // true jika i adalah indeks yang valid untuk kapasitas list
        isIdxEffListDin(ld1, i);    // true jika i adalah indeks yang terdefinisi untuk list  
        isEmptyListDin(ld1);        // true jika list l kosong
        isFullListDin(ld1);         // true jika list l penuh
        break;
